...
import { ExternalCheckoutClient } from "@/components/customer/external-order-client";

interface PageProps {
  searchParams: Promise<{ type?: string }>;
}

export default async function ExternalCheckoutPage({ searchParams }: PageProps) {
  ...
  return <ExternalCheckoutClient menu={menu} orderType={params.type} />;
}
