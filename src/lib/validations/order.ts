...
export const dineInOrderSchema = baseOrderSchema.extend({
  order_type: z.literal("DINE_IN"),
  table_token: z.string().min(16).max(128),
});

export const deliveryOrderSchema = baseOrderSchema.extend({
...
export const pickupOrderSchema = baseOrderSchema.extend({
...
export const createOrderSchema = z.discriminatedUnion("order_type", [
  dineInOrderSchema,
  deliveryOrderSchema,
  pickupOrderSchema,
]);
